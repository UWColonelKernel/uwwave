...
export async function setLocalStorageByKey(key: string, data: any): Promise<void> {
    return setLocalStorage({ [key]: data })
}

export async function getLocalStorage(keys: string | string[] | object | null): Promise<Dictionary> {
    return new Promise((resolve, reject) => {
